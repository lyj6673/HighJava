...
public class BoardController {
	...
	private void insertBoard() {
		...
		boardVo.setBoard_title(b_title);
		boardVo.setBoard_writer(b_writer);
		boardVo.setBoard_content(b_content);
	...
	private int displayMenu(String title) {
		...
		if(boardList==null || boardList.size()==0) {
			...
			for(BoardVo boardVo : boardList) {
				...
				String title2 = boardVo.getBoard_title();
				String writer = boardVo.getBoard_writer();
				int count = boardVo.getBoard_cnt();
